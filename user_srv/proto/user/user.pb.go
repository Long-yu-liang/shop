...
type UserListResponse struct {
	...
	Data          []*UserInfoResonse     `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserListResponse) GetData() []*UserInfoResonse {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *UserInfoResonse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserInfoResonse) ProtoMessage() {}

func (x *UserInfoResonse) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserInfoResonse.ProtoReflect.Descriptor instead.
func (*UserInfoResonse) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{5}
}

func (x *UserInfoResonse) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *UserInfoResonse) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *UserInfoResonse) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
func (x *UserInfoResonse) GetNickName() string {
	if x != nil {
		return x.NickName
	}
	return ""
...
func (x *UserInfoResonse) GetBirthday() uint64 {
	if x != nil {
		return x.Birthday
	}
	return 0
...
func (x *UserInfoResonse) GetGender() string {
	if x != nil {
		return x.Gender
	}
	return ""
...
func (x *UserInfoResonse) GetRole() int32 {
	if x != nil {
		return x.Role
	}
	return 0
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x1a\x1bgoogle/protobuf/empty.proto\"0\n" +
	"\bPageInfo\x12\x0e\n" +
	"\x02pn\x18\x01 \x01(\rR\x02pn\x12\x14\n" +
	"\x05pSize\x18\x02 \x01(\rR\x05pSize\"N\n" +
	"\x10UserListResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x05R\x05total\x12$\n" +
	"\x04data\x18\x02 \x03(\v2\x10.UserInfoResonseR\x04data\"'\n" +
	...
	"\x04role\x18\a \x01(\x05R\x04role\"p\n" +
	...
	"\x04User\x12-\n" +
	"\vGetUserList\x12\t.PageInfo\x1a\x11.UserListResponse\"\x00\x125\n" +
	"\x0fGetUserByMobile\x12\x0e.MobileRequest\x1a\x10.UserInfoResonse\"\x00\x12-\n" +
	"\vGetUserById\x12\n" +
	".IdRequest\x1a\x10.UserInfoResonse\"\x00\x121\n" +
	"\n" +
	"CreateUser\x12\x0f.CreateUserInfo\x1a\x10.UserInfoResonse\"\x00\x127\n" +
	"\n" +
	"UpdateUser\x12\x0f.UpdateUserInfo\x1a\x16.google.protobuf.Empty\"\x00\x125\n" +
	"\rCheckPassword\x12\x12.PasswordCheckInfo\x1a\x0e.CheckResponse\"\x00B\tZ\a.;protob\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*UserInfoResonse)(nil),   // 5: UserInfoResonse
...
var file_user_proto_depIdxs = []int32{
	5, // 0: UserListResponse.data:type_name -> UserInfoResonse
	...
	5, // 8: User.GetUserByMobile:output_type -> UserInfoResonse
	5, // 9: User.GetUserById:output_type -> UserInfoResonse
	5, // 10: User.CreateUser:output_type -> UserInfoResonse
